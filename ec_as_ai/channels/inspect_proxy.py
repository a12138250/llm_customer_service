...
from ec_as_ai.channels.base_channel import InputChannel, UserMessage

if TYPE_CHECKING:
    from ec_as_ai.core.tracker import DialogueStateTracker
    from ec_as_ai.agent.message_processor import MessageProcessor
