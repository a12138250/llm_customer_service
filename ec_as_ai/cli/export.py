...
def export_command(
    ...
    示例:
        ec_as export --output ./export/model.tar.gz
        ec_as export --format zip --output ./export/model.zip
        ec_as export --format json --output ./export/domain.json
    """
