...
所有异常都继承自EcAsException基类。
"""

from typing import Optional, Text


class EcAsException(Exception):
    """ec_as_ai系统的基础异常类
...
class ConfigurationException(EcAsException):
    """配置异常
...
class ModelNotFound(EcAsException):
    """模型未找到异常
...
class ModelLoadException(EcAsException):
    """模型加载异常
...
class ModelTrainingException(EcAsException):
    """模型训练异常
...
class LLMException(EcAsException):
    """LLM异常基类
...
class TrackerStoreException(EcAsException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(EcAsException):
    """对话理解异常基类
...
class ActionException(EcAsException):
    """Action异常基类
...
class ChannelException(EcAsException):
    """通道异常基类
...
class GraphException(EcAsException):
    """图引擎异常基类
...
class RetrievalException(EcAsException):
    """检索异常基类
...
class ValidationException(EcAsException):
    """验证异常基类
